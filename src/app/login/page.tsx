...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string; sent?: string }> }) {
  ...
  return <main className="grid min-h-screen place-items-center bg-canvas px-4 py-10"><div className="w-full max-w-sm rounded-2xl bg-surface p-6 ring-1 ring-line sm:p-8"><Brand /><h1 className="mt-10 text-2xl font-[720] tracking-[-0.02em]">Welcome to Relay</h1><p className="mt-2 text-sm text-muted">Get back to your games and crew.</p>
