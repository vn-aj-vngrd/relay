    ...
    <div className="flex h-dvh flex-col overflow-hidden bg-canvas lg:block">
      <aside className="fixed inset-y-0 left-0 z-30 hidden w-[232px] flex-col bg-canvas px-3 py-3 lg:flex">
        ...
        <div className="mt-auto border-t border-line pt-3">
          <p className="truncate px-2 text-xs text-muted">{admin.email}</p>
          <Link
            href="/home"
            className="sidebar-row pressable mt-2 flex min-h-9 items-center gap-2 rounded-md px-2 text-sm font-medium text-muted hover:bg-surface-strong/70 hover:text-ink"
          >
