...
export default function AdminNotFound() {
  return (
    <main
      id="main-content"
      className="mx-auto flex min-h-screen max-w-lg flex-col justify-center px-5 py-16"
    >
      ...
      <p className="mt-3 leading-7 text-muted">
        The admin page may not exist, or your account may not have permission to
        open it.
      </p>
      <div className="mt-7">
