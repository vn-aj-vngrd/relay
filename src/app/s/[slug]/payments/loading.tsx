  ...
  return (
    ...
    >
      <div className="public-session-panel public-session-content mx-auto max-w-4xl bg-surface px-4 py-8 sm:mt-8 sm:rounded-xl sm:border sm:border-line sm:px-8">
        ...
        <Skeleton className="mt-2 h-3.5 w-[30rem] max-w-full" />
        <section className="public-session-section mt-8 grid min-w-0 gap-6 border-y border-line sm:grid-cols-[minmax(0,1fr)_220px]">
