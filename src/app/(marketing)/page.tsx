...
export default async function MarketingPage() {
  ...
  return <main id="main-content" className="marketing-page min-h-screen bg-[#f7f7f5] text-[#171719]">
    ...
    <section id="play" className="border-y border-[#deded9] bg-white px-5 py-20 sm:px-8 sm:py-32">
      <div data-marketing-reveal="sequence" className="mx-auto max-w-[1180px]"><div className="grid items-end gap-8 lg:grid-cols-[.9fr_1.1fr]"><div><p className="text-sm font-semibold text-[#526415]">When everyone arrives</p><h2 className="mt-4 max-w-xl text-3xl font-[620] tracking-[-0.038em] sm:text-5xl">The court view becomes the product.</h2></div><p className="max-w-xl text-base leading-7 text-[#66666c] lg:justify-self-end">Large scores, active teams, the paddle stack, and session standings share one glanceable surface. Score every point live or enter only the result—the night works either way.</p></div><div className="mt-12"><ProductShot src="/images/product/play.webp" alt="Relay Play showing two active pickleball courts, large scores, the paddle stack, rotation rule, and session standings" caption="Play with two active courts" mobileFocus="center" /></div><div className="mt-10 grid border-y border-[#deded9] sm:grid-cols-2 lg:grid-cols-4"><div className="py-6 sm:pr-8"><h3 className="font-semibold">Paddle Stack</h3><p className="mt-2 text-sm leading-6 text-[#66666c]">Continuous play with mixed partners or pairs that stay together.</p></div><div className="border-t border-[#deded9] py-6 sm:border-l sm:border-t-0 sm:pl-8 lg:px-8"><h3 className="font-semibold">Mix It Up</h3><p className="mt-2 text-sm leading-6 text-[#66666c]">Social rounds that prioritize fair rests and reduce repeated partners.</p></div><div className="border-t border-[#deded9] py-6 sm:pr-8 lg:border-l lg:border-t-0 lg:px-8"><h3 className="font-semibold">Court Climb</h3><p className="mt-2 text-sm leading-6 text-[#66666c]">Winners move toward Court 1, losers move down, and partners split.</p></div><div className="border-t border-[#deded9] py-6 sm:border-l sm:pl-8 lg:border-t-0"><h3 className="font-semibold">Team Round Robin</h3><p className="mt-2 text-sm leading-6 text-[#66666c]">Keep partners and play every other pair once, with automatic byes.</p></div></div></div>
    </section>
