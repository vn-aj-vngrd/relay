...
export default async function GamesPage() {
  ...
  return <div><div className="flex items-end justify-between gap-4"><div><h1 className="app-title">Games</h1><p className="mt-2 text-muted">Plans, play, and the nights you kept.</p></div><span className="hidden sm:block"><ButtonLink href="/games/new"><CalendarPlus size={17} />Create game</ButtonLink></span></div>
