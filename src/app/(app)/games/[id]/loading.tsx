...
export default function SessionLoading() {
  return <><GamePageIntro title="Overview" description="The plan, roster, setup progress, and next action for this game." /><div role="status" aria-label="Loading game overview" aria-busy="true" className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_340px]">
