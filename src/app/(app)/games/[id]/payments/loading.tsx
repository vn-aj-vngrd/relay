...
export default function PaymentsLoading() {
  return (
    <>
      ...
      <div role="status" aria-label="Loading payments" aria-busy="true" className="grid gap-8 lg:grid-cols-[1fr_340px]">
        <section>
        ...
        <aside className="self-start rounded-lg border border-line p-5">
