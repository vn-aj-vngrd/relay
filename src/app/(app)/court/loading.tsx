...
export default function VenuesLoading() {
  return (
    ...
    >
      ...
      <div className="shrink-0 border-b border-line pb-3 sm:mt-7 lg:border-y lg:py-4">
      ...
      <div className="-mx-4 grid min-h-0 gap-3 sm:mx-0 sm:gap-4 xl:mt-4 xl:flex-1 xl:grid-cols-[360px_minmax(0,1fr)]">
