  ...
  return (
    <div className="mx-auto w-full max-w-6xl">
      ...
      <div className="max-w-2xl pt-5 sm:pt-8">
        ...
        <p className="mt-2 max-w-xl text-muted">Update the crew’s name, description, and group photo.</p>
        <EditGroupForm
          group={{ id: group.id, slug: group.slug, name: group.name, description: group.description }}
