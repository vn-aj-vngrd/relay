  ...
  return (
    <div role="status" className="mx-auto w-full max-w-6xl" aria-label="Loading notifications" aria-busy="true">
      ...
      <nav aria-label="Notification filters" className="flex border-b border-line">
        <Link href="/notifications" className="flex min-h-11 items-center px-3 text-sm font-medium text-ink">
          All
        </Link>
        <Link
      ...
      <section className="pt-7">
        <div className="divide-y divide-line border-y border-line">
          {Array.from({ length: 4 }, (_, index) => (
            <div key={index} className="flex min-h-20 items-start gap-3 px-1 py-4 sm:px-3">
