...
export function GlobalSearch({ initialQuery = "", initialFilter = "all" }: { initialQuery?: string; initialFilter?: SearchFilter }) {
  ...
  return <div className="mx-auto w-full max-w-4xl"><header><h1 className="app-title">Search Relay</h1><p className="mt-2 text-muted">Find games, players, groups, and places to play.</p></header>
