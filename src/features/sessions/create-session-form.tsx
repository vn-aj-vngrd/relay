...
export function CreateSessionForm({ defaults }: { defaults: CreateSessionDefaults }) {
  ...
  return <form className="space-y-8" action={action}>
    {state.error ? <p role="alert" className="rounded-[10px] bg-[oklch(.96_.035_25)] p-3 text-sm font-medium text-danger">{state.error}</p> : null}
