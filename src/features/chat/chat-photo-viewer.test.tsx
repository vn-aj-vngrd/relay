...
describe("ChatPhotoViewer", () => {
  it("opens a full photo dialog and provides an explicit close action", () => {
    render(<ChatPhotoViewer src="https://test.supabase.co/photo.jpg" alt="Photo from Mika" sender="Mika" />);
    fireEvent.click(screen.getByRole("button", { name: "Open photo from Mika" }));
