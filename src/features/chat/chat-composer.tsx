...
export function ChatComposer({ sessionId, slug, maxImageBytes = DEFAULT_CHAT_IMAGE_MAX_BYTES }: { sessionId: string; slug?: string; maxImageBytes?: number }) {
