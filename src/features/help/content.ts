...
export const helpArticles: readonly HelpArticle[] = [
  ...
  },
  {
    ...
    steps: [
      "Open Quick Play. You may briefly see Opening Quick Play on this device while Relay checks for your saved setup, game, or recap. For a new setup, enter distinct player names, or choose Paste names and enter one name per line. Add names keeps your existing named players, replaces blank slots, and checks duplicates and the 24-player limit. Review or edit the roster before continuing. To save and share a game instead, choose Create game beside Continue at the bottom of the Players step. Your unfinished setup is kept in this browser, including the current step.",
