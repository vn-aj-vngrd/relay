import { ArrowRight, CheckCircle, EnvelopeSimple } from "@phosphor-icons/react/dist/ssr";
...
export function EmailSentState({
  ...
  return (
    <section aria-labelledby="email-sent-title" className="w-full max-w-[410px] text-center">
      ...
      <h1 id="email-sent-title" className="mt-5 text-[1.75rem] font-[650] tracking-[-0.025em]">
        {title}
      </h1>
      <p className="mx-auto mt-3 max-w-sm text-[15px] leading-6 text-muted">{description}</p>
