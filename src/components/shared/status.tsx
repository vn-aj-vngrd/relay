import { Broadcast, CheckCircle, CircleDashed, CurrencyCircleDollar } from "@phosphor-icons/react/dist/ssr";

const styles = {
  confirmed: { icon: CheckCircle, className: "text-success", label: "Court confirmed" },
  pending: { icon: CircleDashed, className: "text-muted", label: "Booking pending" },
  paid: { icon: CurrencyCircleDollar, className: "text-success", label: "Paid" },
  due: { icon: CurrencyCircleDollar, className: "text-warning", label: "Payment due" },
