...
function SignOutButton() {
  ...
  return <button role="menuitem" disabled={pending} className="flex min-h-9 w-full items-center gap-2 rounded-md px-2 text-sm text-muted hover:bg-surface-strong hover:text-ink disabled:opacity-50">{pending ? <ButtonSpinner /> : <SignOut size={17} />}{pending ? "Signing out…" : "Sign out"}</button>;
}
