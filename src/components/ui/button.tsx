...
const base = "pressable inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border px-4 text-sm font-[700] disabled:pointer-events-none disabled:opacity-45";
