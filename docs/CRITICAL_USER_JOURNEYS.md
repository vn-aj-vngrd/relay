...
| A06 — Guided Agent creation and approval | + and / open enabled creation forms; chat prefills known details; named fields and Back/Next retain answers; desktop dialog/mobile sheet; review discloses effects; only explicit approval creates; edits invalidate old approval IDs | Creation form-model, wizard, route and confirmation regressions; synthetic desktop/mobile Agent fixture. Execution deferred; real database concurrency and live provider handoff unverified. |
