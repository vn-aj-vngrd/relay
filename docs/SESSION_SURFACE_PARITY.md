...
- Create offers Decide later (unset), Free, or Collect payment. Game settings → Payments owns ongoing configuration; Payments retains tracking/proof/review and exact settings links. A collection without assigned shares says the share will be calculated when players join, not that the host has not set up payment.
