...
- **Code quality:** Read `docs/CODE_QUALITY.md` before adding dependencies, changing TypeScript/lint/format conventions, or preparing a production change. Run its complete gate.
